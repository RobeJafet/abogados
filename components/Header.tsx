                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex">
                        ...
                        <div ref={menuButtonRef}>
                            <button
                                className="menu-button flex gap-x-4 lg:hidden text-black px-6 md:px-8 py-4 link bg-white border-l border-t border-b border-r border-gray cursor-pointer"
